...
main = function (){
	...
	function init () {
		...
		if(!isMobile){
			...
			//hide video
			setSkrollr($('#blogger-content'), [[2100 - 700, 'opacity:0;top:100px'], [2600 - 700, 'opacity:1;top:50px'], [3200 - 700, 'opacity:1;top:-50px']]);
			setSkrollr($('#form-content'), [[2600 - 700, 'opacity:0;top:150px'], [3100 - 700, 'opacity:1;top:0px'], [3600 - 700, 'opacity:1;top:-100px']]);
